...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
        ...
        private void UpdateImGuiInput(GameWindow wnd)
        {
            ...
            var screenPoint = new Vector2((int)MouseManager.WindowPositionX, (int)MouseManager.WindowPositionY);
            var point = wnd.PointToClient(new System.Drawing.Point((int)MouseManager.WindowPositionX, (int)MouseManager.WindowPositionY));
        ...
        public uint StartDockspace(string dockSpaceName)
        {
            ...
            bool open = true;
            ImGui.Begin(dockSpaceName, ref open, windowFlags);

            ImGui.PopStyleVar(2);

            // The C++ demo shows how to remove the background so the game can show through.
            return ImGui.DockSpace(ImGui.GetID(dockSpaceName));
        }
